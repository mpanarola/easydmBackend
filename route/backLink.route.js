...
const { checkBackLinks, valResult } = require('../middleware/validation.middleware')

router.post('/create_backlink', authMiddleware, checkBackLinks, valResult, backLink.createBackLinks)
